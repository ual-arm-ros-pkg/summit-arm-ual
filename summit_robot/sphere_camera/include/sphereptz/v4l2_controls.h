/*******************************************************************************#
#           guvcview              http://guvcview.berlios.de # # # # Paulo Assis
<pj.assis@gmail.com>                                    # # # # This program is
...
/*
 * Private V4L2 control identifiers from UVC driver.  - this seems to change
 * acording to driver version all other User-class control IDs are defined by
 * V4L2 (videodev2.h)
 */
...
#define V4L2_CID_WHITE_BALANCE_TEMPERATURE_AUTO_OLD \
    (V4L2_CID_PRIVATE_BASE_OLD + 12)
