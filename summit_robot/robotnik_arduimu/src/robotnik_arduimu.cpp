...
//T:-964,AX:1739,AY:-62,AZ:7698,GX:4312,GY:-3573,GZ:-1459,MX:-307,MY:-2,MZ:319,MH:173.63,LT:0,LN:0,AT:0,CG:0,SG:0,FX:0,ST:0,TW:0,
	...
	for (j=0;j<i;j++) {
		...
		if (i==TOKENS_IMU) {
			...
			if(!strcmp(cReceivedSubTokens[0], "X")) aX_ = atoi(cReceivedSubTokens[1]);
			if(!strcmp(cReceivedSubTokens[0], "Y")) aY_ = atoi(cReceivedSubTokens[1]);
			if(!strcmp(cReceivedSubTokens[0], "Z")) aZ_ = atoi(cReceivedSubTokens[1]);
