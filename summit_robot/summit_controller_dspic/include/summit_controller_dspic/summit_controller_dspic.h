...
#define DSPIC_D_WHEELS_M			0.372	// Distance back axis to front axis car-type kinematics
...
private:
	...
	int iCmd;
	//! Flag to decide if the odometry is calculated inside the component or read from the external dsPic device
...
public:
    ...
    bool set_mode(robotnik_msgs::set_mode::Request& request, robotnik_msgs::set_mode::Response& response);
