...
class IMU
{
   ...
   public:
     ...
     *
     * \param fix_off this fixed offset will be added to the timestamp of the
     * imu
     */
     ...
     */
    void receiveAccelAngrateOrientation(
        uint64_t* time, double accel[3], double angrate[3],
        double orientation[9]);
     ...
     * \param orientation orientation matrix which will be filled
     */
    void receiveAccelAngrateMagOrientation(
        uint64_t* time, double accel[3], double angrate[3], double mag[3],
        double orientation[9]);
   ...
   private:
    ...
    int receive(
        uint8_t command, void* rep, int rep_len, int timeout = 0,
